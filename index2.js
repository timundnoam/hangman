const animals = [
   ...
   randomWord = () => {
       ...
       console.log('c', charArray);
   
    
   
       let animalWordLength = charArray.length;
   ...
   function checkKey(key) {
       ...
       const idx = charArray.findIndex((char) => char === key);
       ...
       if (idx >= 0) {
           ...
           console.log('buchstabe ist drin', idx);
           ...
           console.log('a1', newArray);
           newArray.push(...charArray.filter(c => c.toLowerCase() === key.toLowerCase()));
           console.log('newArray', newArray);
    
   if (newArray.length === charArray.length) {
